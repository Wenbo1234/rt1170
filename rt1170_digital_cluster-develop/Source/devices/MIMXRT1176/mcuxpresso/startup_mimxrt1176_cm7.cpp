...
WEAK void LCDIF1_IRQHandler(void);
WEAK void LCDIF2_IRQHandler(void);
...
WEAK void CAAM_RTC_IRQHandler(void);
...
WEAK void MECC1_INIT_IRQHandler(void);
WEAK void MECC1_FATAL_INIT_IRQHandler(void);
WEAK void MECC2_INIT_IRQHandler(void);
WEAK void MECC2_FATAL_INIT_IRQHandler(void);
WEAK void XECC_FLEXSPI1_INIT_IRQHandler(void);
WEAK void XECC_FLEXSPI1_FATAL_INIT_IRQHandler(void);
WEAK void XECC_FLEXSPI2_INIT_IRQHandler(void);
WEAK void XECC_FLEXSPI2_FATAL_INIT_IRQHandler(void);
WEAK void XECC_SEMC_INIT_IRQHandler(void);
WEAK void XECC_SEMC_FATAL_INIT_IRQHandler(void);
...
//*****************************************************************************
void DMA0_0_16_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_1_17_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_2_18_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_3_19_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_4_20_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_5_21_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_6_22_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_7_23_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_8_24_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_9_25_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_10_26_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_11_27_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_12_28_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_13_29_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_14_30_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DMA0_15_31_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void LCDIF1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void LCDIF2_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void CAAM_RTC_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void MECC1_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void MECC1_FATAL_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void MECC2_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void MECC2_FATAL_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_FLEXSPI1_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_FLEXSPI1_FATAL_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_FLEXSPI2_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_FLEXSPI2_FATAL_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_SEMC_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void XECC_SEMC_FATAL_INIT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    LCDIF1_IRQHandler,                    // 70 : LCDIF1 interrupt
    LCDIF2_IRQHandler,                    // 71 : LCDIF2 interrupt
    ...
    SNVS_HP_WRAPPER_IRQHandler,           // 82 : SRTC Consolidated Interrupt. Non TZ
    SNVS_HP_WRAPPER_TZ_IRQHandler,        // 83 : SRTC Security Interrupt. TZ
    SNVS_LP_WRAPPER_IRQHandler,           // 84 : ON-OFF button press shorter than 5 secs (pulse event)
    ...
    CAAM_RTC_IRQHandler,                  // 90 : CAAM interrupt for RTC
    ...
    SFA_IRQHandler,                       // 110: SFA interrupt
    ...
    MECC1_INIT_IRQHandler,                // 222: MECC1 init
    MECC1_FATAL_INIT_IRQHandler,          // 223: MECC1 fatal init
    MECC2_INIT_IRQHandler,                // 224: MECC2 init
    MECC2_FATAL_INIT_IRQHandler,          // 225: MECC2 fatal init
    XECC_FLEXSPI1_INIT_IRQHandler,        // 226: XECC init
    XECC_FLEXSPI1_FATAL_INIT_IRQHandler,  // 227: XECC fatal init
    XECC_FLEXSPI2_INIT_IRQHandler,        // 228: XECC init
    XECC_FLEXSPI2_FATAL_INIT_IRQHandler,  // 229: XECC fatal init
    XECC_SEMC_INIT_IRQHandler,            // 230: XECC init
    XECC_SEMC_FATAL_INIT_IRQHandler,      // 231: XECC fatal init
...
//*****************************************************************************
WEAK void DMA0_DMA16_IRQHandler(void)
{   DMA0_0_16_DriverIRQHandler();
}

WEAK void DMA1_DMA17_IRQHandler(void)
{   DMA0_1_17_DriverIRQHandler();
}

WEAK void DMA2_DMA18_IRQHandler(void)
{   DMA0_2_18_DriverIRQHandler();
}

WEAK void DMA3_DMA19_IRQHandler(void)
{   DMA0_3_19_DriverIRQHandler();
}

WEAK void DMA4_DMA20_IRQHandler(void)
{   DMA0_4_20_DriverIRQHandler();
}

WEAK void DMA5_DMA21_IRQHandler(void)
{   DMA0_5_21_DriverIRQHandler();
}

WEAK void DMA6_DMA22_IRQHandler(void)
{   DMA0_6_22_DriverIRQHandler();
}

WEAK void DMA7_DMA23_IRQHandler(void)
{   DMA0_7_23_DriverIRQHandler();
}

WEAK void DMA8_DMA24_IRQHandler(void)
{   DMA0_8_24_DriverIRQHandler();
}

WEAK void DMA9_DMA25_IRQHandler(void)
{   DMA0_9_25_DriverIRQHandler();
}

WEAK void DMA10_DMA26_IRQHandler(void)
{   DMA0_10_26_DriverIRQHandler();
}

WEAK void DMA11_DMA27_IRQHandler(void)
{   DMA0_11_27_DriverIRQHandler();
}

WEAK void DMA12_DMA28_IRQHandler(void)
{   DMA0_12_28_DriverIRQHandler();
}

WEAK void DMA13_DMA29_IRQHandler(void)
{   DMA0_13_29_DriverIRQHandler();
}

WEAK void DMA14_DMA30_IRQHandler(void)
{   DMA0_14_30_DriverIRQHandler();
}

WEAK void DMA15_DMA31_IRQHandler(void)
{   DMA0_15_31_DriverIRQHandler();
}
...
WEAK void MECC1_INIT_IRQHandler(void)
{   MECC1_INIT_DriverIRQHandler();
}

WEAK void MECC1_FATAL_INIT_IRQHandler(void)
{   MECC1_FATAL_INIT_DriverIRQHandler();
}

WEAK void MECC2_INIT_IRQHandler(void)
{   MECC2_INIT_DriverIRQHandler();
}

WEAK void MECC2_FATAL_INIT_IRQHandler(void)
{   MECC2_FATAL_INIT_DriverIRQHandler();
}
...
WEAK void XECC_SEMC_INIT_IRQHandler(void)
{   XECC_SEMC_INIT_DriverIRQHandler();
}

WEAK void XECC_SEMC_FATAL_INIT_IRQHandler(void)
{   XECC_SEMC_FATAL_INIT_DriverIRQHandler();
}
