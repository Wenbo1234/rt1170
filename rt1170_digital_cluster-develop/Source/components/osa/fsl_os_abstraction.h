...
#else
#define OSA_TASK_PRI_SET(name, priority) os_thread_def_##name.tpriority = priority
#define OSA_TASK_NAME_SET(name, newname) os_thread_def_##name.tname = newname
#define OSA_TASK_STACK_SIZE_SET(name, size) os_thread_def_##name.stacksize = size                                          
#endif
#endif
