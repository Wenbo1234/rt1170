...
status_t DC_FB_ELCDIF_Init(const dc_fb_t *dc)
{
    ...
    if (0 == dcHandle->initTimes++)
    {
        ...
        //elcdifConfig.pixelFormat   = DC_FB_ELCDIF_RGB888_PIXEL_FORMAT_ELCDIF;
        // added by wenbo for ARGB888 test
        elcdifConfig.pixelFormat   = DC_FB_ELCDIF_XRGB888_PIXEL_FORMAT_ELCDIF;
