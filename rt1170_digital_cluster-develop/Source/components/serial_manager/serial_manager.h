...
#define SERIAL_MANAGER_TASK_PRIORITY (1U)
...
typedef enum _serial_manager_status
{
    ...
    kStatus_SerialManager_DcdNotReady =
        MAKE_STATUS(kStatusGroup_SERIALMANAGER, 7), /*!< The USB VCOM not plugged or not opened */
