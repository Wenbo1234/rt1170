...
static mlan_status wlan_uap_set_wapi_ie(mlan_private *priv, pmlan_ioctl_req pioctl_req)
{
    ...
    if (misc->param.gen_ie.len)
    {
        ...
        memcpy(priv->adapter, priv->wapi_ie, misc->param.gen_ie.ie_data, misc->param.gen_ie.len);
...
static mlan_status wlan_uap_sec_ioctl_wapi_enable(IN pmlan_adapter pmadapter, IN pmlan_ioctl_req pioctl_req)
{
    ...
    else
    {
        ...
        {
            memset(pmpriv->adapter, pmpriv->wapi_ie, 0, sizeof(pmpriv->wapi_ie));
...
static mlan_status wlan_uap_get_bss_info(IN pmlan_adapter pmadapter, IN pmlan_ioctl_req pioctl_req)
{
    ...
    /* BSSID */
    memcpy(pmadapter, &info->param.bss_info.bssid, pmpriv->curr_addr, MLAN_MAC_ADDR_LENGTH);
