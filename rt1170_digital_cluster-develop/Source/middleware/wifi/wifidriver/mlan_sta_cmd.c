                                          ...
                                          IN hs_config_param *pdata_buf)
{
        ...
        ((pmadapter->arp_filter_size > 0) && (pmadapter->arp_filter_size <= ARP_FILTER_MAX_BUF_SIZE)))
    {
        ...
        memcpy(pmpriv->adapter, ((t_u8 *)phs_cfg) + sizeof(HostCmd_DS_802_11_HS_CFG_ENH), pmadapter->arp_filter,
               pmadapter->arp_filter_size);
        cmd->size =
...
#define KEYPARAMSET_WEP_FIXED_LEN 8
            ...
            memmove(priv->adapter, &key_param_set->key[2], priv->wep_key[i].key_material, priv->wep_key[i].key_length);
    ...
    if (cmd_action == HostCmd_ACT_ADD)
    {
        ...
        switch (priv->wep_key[0].key_length)
        {
            case WEP_40_BIT_LEN:
                ...
                memmove(priv->adapter, wep->wep1, priv->wep_key[0].key_material, priv->wep_key[0].key_length);
                break;
        ...
        switch (priv->wep_key[1].key_length)
        {
            case WEP_40_BIT_LEN:
                ...
                memmove(priv->adapter, wep->wep2, priv->wep_key[1].key_material, priv->wep_key[1].key_length);
                break;
            case WEP_104_BIT_LEN:
        ...
        switch (priv->wep_key[2].key_length)
        {
            case WEP_40_BIT_LEN:
                ...
                memmove(priv->adapter, wep->wep3, priv->wep_key[2].key_material, priv->wep_key[2].key_length);
                break;
            case WEP_104_BIT_LEN:
        ...
        switch (priv->wep_key[3].key_length)
        {
            case WEP_40_BIT_LEN:
                ...
                memmove(priv->adapter, wep->wep4, priv->wep_key[3].key_material, priv->wep_key[3].key_length);
                break;
            case WEP_104_BIT_LEN:
    ...
    IN pmlan_private pmpriv, IN HostCmd_DS_COMMAND *cmd, IN t_u16 cmd_action, IN t_u32 cmd_oid, IN t_void *pdata_buf)
{
    ...
    if (pkey->is_wapi_key)
    {
        ...
        memcpy(pmpriv->adapter, pkey_material->key_param_set.key_params.wapi.key, pkey->key_material, pkey->key_len);
    ...
    IN pmlan_private pmpriv, IN HostCmd_DS_COMMAND *cmd, IN t_u16 cmd_action, IN t_u32 cmd_oid, IN t_void *pdata_buf)
{
    ...
    if (pkey->is_wapi_key)
    {
        ...
        memcpy(pmpriv->adapter, &pkey_material->key_param_set.key[2 + pkey->key_len], pkey->pn, PN_SIZE);
