...
#define BOARD_NAME "MIMXRT1170-DCLUSTER"
...
#elif DEBUG_CONSOLE_UART_INDEX == 11
#define BOARD_DEBUG_UART_BASEADDR (uint32_t) LPUART11
#define BOARD_DEBUG_UART_INSTANCE 11U
#define BOARD_UART_IRQ LPUART11_IRQn
#define BOARD_UART_IRQ_HANDLER LPUART11_IRQHandler
...
#define BOARD_WIFI_SD_DETECT_TYPE kSDMMCHOST_DetectCardByGpioCD
